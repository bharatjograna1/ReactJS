...
export default (state = INITIAL_STATE, action) => {
    switch (action.type) {
        ...
        // get wallets
        case GET_WD_WALLETS:
            return { ...state, loading: true, response: {}, balance: {}, response2fa: { loading: false }, errors: {} };
        ...
        case GET_WD_BALANCE:
            return { ...state, loading: true, balance: {}, addresses: [], response2fa: { loading: false }, errors: {} }
        ...
        case GET_FEEANDLIMIT:
            return { ...state, loading: true, feeAndLimit: {}, response2fa: { loading: false }, errors: {} }
        ...
        // DO WITHDRAW
        case DO_WITHDRAW:
            return { ...state, loading: true, response: {}, errors: {}, response2fa: { loading: false }, }
        ...
        case ADDRESSBYWALLETID:
            return { ...state, loading: true, response: {}, addresses: [], response2fa: { loading: false }, errors: {} }
        ...
        case WITHDRAWA2FAAUTH:
            return { ...state, response2fa: { loading: true }, errors: {} }
        ...
        case WITHDRAWCONFRIMATION:
            return { ...state, confirmationResponse: { loading: true }, errors: {} }
