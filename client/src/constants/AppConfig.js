...
const social = localStorage.getItem('general') !== 'undefined' && localStorage.getItem('social') ? JSON.parse(localStorage.getItem('social')) : '';
const AppConfig = {
    ...
    socketAPIUrl: 'wss://new-stack-socket-api.azurewebsites.net/',
    // socketAPIUrl: 'ws://172.20.65.131:8082',//'wss://new-stack-socket-api.azurewebsites.net/', //Added by salim for socket API Url..
    ...
    //myAccountSwaggerUrl : 'https://cleandevtest.azurewebsites.net/SSOAccountStaging/', //added by salim, client side
    myAccountSwaggerUrl: 'https://cleandevtest.azurewebsites.net/SSOAccountStaging/', //added by salim,
    // myAccountSwaggerUrl : ' https://cleandevtest.azurewebsites.net/SSOAccountStaging_Staging/', //added by salim,
    // myAccountSwaggerUrl : 'https://cleandevtest.azurewebsites.net/SPAOnCoreV2/', //added by salim,
    totalOrders: 1000, // added by Tejas,
    //signalRURL : 'https://cleandevtest.azurewebsites.net/SSOAccountStaging/chathub',
    //signalRURL : 'https://cleandevtest.azurewebsites.net/SSOAccountStaging/Market', // client side url
    signalRURL: 'https://cleandevtest.azurewebsites.net/SSOAccountStaging/Market', // local url
    siteId: 1,
    coinlistImageurl: 'https://cleandevtest.azurewebsites.net/SSOAccountStaging/CurrencyLogo',
    ...
    signalRChatURL: 'https://cleandevtest.azurewebsites.net/SSOAccountStaging/Chat',
    //Survey Type
    survey: {
        'feature_survey': '1',
        'coinlist_survey': '2',
