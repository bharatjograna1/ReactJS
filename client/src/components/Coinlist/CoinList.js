  ...
  render() {
    ...
    return (
      ...
      <div className="coin-list-table">
        <JbsCollapsibleCard heading={<IntlMessages id="sidebar.coinList" />} customClasses="py-0">
                ...
                <tbody>
                  {Coinlist &&
                    Coinlist.map((coinlist, key) => (
                      <tr key={key}>
                        <td>
                          <img src={AppConfig.coinlistImageurl+'/'+coinlist.SMSCode+'.png'} height="20" width="20" className="mr-15" />
                          <Link
                          to={{
