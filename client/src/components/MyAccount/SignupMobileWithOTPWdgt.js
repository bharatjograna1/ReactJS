...
class SignupMobileWithOTPWdgt extends Component {
    ...
    componentWillReceiveProps(nextProps) {
        ...
        if (nextProps.redirect) {
            //this.props.history.push('/app/dashboard/trading');
    ...
    onSubmit(event) {
        ...
        if (isValid) {
            ...
            //this.setState({ mobile : mObj.mobile });
    ...
    render() {
        const { loading, err_alert, err_msg, success_alert, success_msg, mobile, otp_screen, otp, errors, tem_mobile, CountryCode } = this.state;
        return (
            <Fragment>
                    ...
                    otp_screen
                        ...
                        <Form>
                            ...
                            <FormGroup className="mb-15">
                                <Button disabled={loading} type="submit" className="btn-info text-white" variant="raised" size="large" onClick={this.verifyOTP}><IntlMessages id="sidebar.btnVerifyOTP" /></Button>
                            </FormGroup>
                        ...
                        <Form>
                            <FormGroup className="has-wrapper" id="countryCode">
                                ...
                                {/* <Input type="text" value={mobile} name="mobile" id="mobile" className="has-input input-lg" placeholder="Enter mobile" onChange={this.onChange} /> */}
