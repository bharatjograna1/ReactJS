            ...
            {this.allStepsCompleted() ? (
              ...
              <div className="clearfix">
                ...
                <div className="float-right mt-10">
                  <MatButton  id="glg_btn_back"  variant="raised"  className=" btn-danger text-white ml-10 mb-10" disabled={activeStep === 0}   onClick={this.handleBack}>
                  <IntlMessages id="sidebar.btnBack" />
                  </MatButton>
                  
                  <MatButton  id="glg_btn_next"  variant="raised"  className="btn-primary text-white ml-10 mb-10" disabled={activeStep === 3}   onClick={this.handleNext}>
                  <IntlMessages id="sidebar.btnNext" />
                  </MatButton>
                </div>
              </div>
            )}
