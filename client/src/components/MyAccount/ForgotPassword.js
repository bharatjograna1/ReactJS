            ...
            <Fragment>
                ...
                <Form>
                    ...
                    <FormGroup className="mb-15 text-left clearfix">
                        ...
                        <Button disabled={loading} type="submit" className="btn-info text-white float-right" variant="raised" onClick={this.onSubmit}><IntlMessages id="sidebar.btnSubmit" /></Button>
                    </FormGroup>
                </Form>
            </Fragment>
        );
