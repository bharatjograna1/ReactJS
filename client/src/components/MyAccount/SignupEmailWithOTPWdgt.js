...
class SignupEmailWithOTPWdgt extends Component {
    ...
    componentWillReceiveProps(nextProps) {
        ...
        if (nextProps.redirect) {
            ...
            //this.setState({ loading: true, otp_screen: true, success_msg: nextProps.data.ReturnMsg, success_alert: true });
    ...
    render() {
        const { loading, err_alert, err_msg, success_alert, success_msg, btn_disabled, email, otp_screen, otp, errors } = this.state;
        return (
            <Fragment>
