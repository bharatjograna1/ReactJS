							...
							<table className={this.props.darkMode ? 'TowFactorlist-darkmode d-sm-full':'TowFactorlist d-sm-full'}>
								<tbody>
									{/* <tr>
										...
										<td>
											<img className="img-fluid d-xs-none" alt="share" width="50" height="50" src={require("Assets/img/smsicon-1.png")} />
										</td>
										<td>
											<span><IntlMessages id="my_account.smsAuthentication" /></span>
											<p><IntlMessages id="my_account.smsAuthNote" /></p>
										</td>
										<td>
											{
												sms2Fa
												?
												<Button onClick={() => this.loadComponentView('View3')} className="btn btn-danger text-white text-center mt-10">
													<IntlMessages id="sidebar.btnDisable" />
												</Button>
												:
												<Button onClick={() => this.loadComponentView('View2')} className="btn btn-success text-white text-center mt-10">
