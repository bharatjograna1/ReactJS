...
const MembershipButton = ({ plan_type, button_type }) => {
	...
	if (plan_type === "Basic") {
		...
		// ButtonLevel = <Link className="btn-block bg-warning btn text-white btn-lg" to="/app/my-account/verify-documents-type">{button_type}</Link>;
						...
						<div className="col-md-4" key={key}>
							<JbsCollapsibleCard customClasses="text-center">
								...
								<div className={`text-center pl-10`}>
									...
									{/* <h1 className={`text-primary pricing-title`}>{list.TypeId}</h1> */}
									<div>
									...
									<div className="mt-30">
										<div className="w-75 mx-auto">
											{/* {list.ActiveStatus
												?
												<Button color="primary" className="btn-block btn-lg">{list.LevelName}</Button>
												:
