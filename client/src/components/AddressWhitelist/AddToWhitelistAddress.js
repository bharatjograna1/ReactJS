...
class AddToWhitelistAddress extends Component {
    ...
    componentWillReceiveProps(nextProps) {
        ...
        //show notification on google auth failed
        // if (nextProps.errors.hasOwnProperty("ErrorCode")) {
        //     NotificationManager.error(<IntlMessages id={`apiErrCode.${nextProps.errors.ErrorCode}`} />);
        // }
            ...
            <Fragment>
                    ...
                    <div className="jbs-block-content mb-0">
                        <div className="clearfix">
                            ...
                            <Form onSubmit={this.handleSubmit} className="col-sm-8 offset-sm-2">
                                <FormGroup row>
                                    <Label for="coin" sm={2} className="offset-sm-1">
                                        <IntlMessages id="lable.coin" />
                                    </Label>
                                    <Col sm={7}>
                                        <Select
                                ...
                                <FormGroup row>
                                    <Label for="lable" sm={2} className="offset-sm-1">
                                        <IntlMessages id="lable.lable" />
                                    </Label>
                                    <Col sm={7}>
                                        <Input
                                            type="text"
                                ...
                                <FormGroup row>
                                    <Label for="address" sm={2} className="offset-sm-1">
                                ...
                                <Col className="justify-content-center d-flex">
                                    <Button className="border-0 rounded-0" color="primary"><IntlMessages id="lable.addToWhitelist" /></Button>
                                </Col>
                            </Form>
                        </div>
                    </div>
                ...
                >
                    ...
                    <DialogActions>
                        ...
                        <Button onClick={(e) => this.handleClose(e, true)} color="primary" autoFocus>
