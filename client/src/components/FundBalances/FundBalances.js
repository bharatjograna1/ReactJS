...
const BalanceWidget = ({ coin, balance, getDetails, wallets, loading }) => (
    <div className={classNames("social-card my-10 mx-5")}>
                                            ...
                                            <div className="media-body pt-5">
                                                ...
                                                <div className="col-sm-12 justify-content-between d-flex">
                                                    <span className="w-50 mx-5">
                                                        <span className="font-weight-bold text-center">{wallet.Wallet.Balance.ShadowBalance}</span>
                                                        <span className="fs-14 badge badge-danger">{<IntlMessages id="wallet.lien" />}</span>
                                                    </span>
                                                    <span className="w-50 mx-5">
                                                        <span className="font-weight-bold text-center">{wallet.Wallet.Balance.StackingBalance}</span>
                                                        <span className="fs-14 badge badge-warning">{<IntlMessages id="wallet.stack" />}</span>
                                                    </span>
                                                </div>
                                                <div className="col-sm-12 justify-content-between d-flex">
                                                    <span className="w-50 mx-5">
                                                        <span className="font-weight-bold text-center">{wallet.Wallet.Balance.UnClearedBalance}</span>
                                                        <span className="fs-14 badge badge-info">{<IntlMessages id="wallet.pending" />}</span>
                                                    </span>
                                                    <span className="w-50 mx-5">
                                                        <span className="font-weight-bold text-center">{wallet.Wallet.Balance.AvailableBalance}</span>
        ...
        return (
            <div>
                ...
                <div className="row d-flex justify-content-between">
                    <div className="w-20 d-flex pl-20 pb-10 justify-content-between">
                    ...
                    <div className="pr-20 pt-10">
                        {<IntlMessages id="wallet.estimatedValue" />}：<span className="font-weight-bold">{this.state.TotalBalance}</span>
                    </div>
                </div>
                <div className="row d-flex justify-content-between">
                    <div className="w-30 float-left pl-20 pb-10">
                        <Switch onChange={() => this.handleToggle()} checked={this.state.hideZero} /> {<IntlMessages id="wallet.hidezerobal" />}
                    </div>
                    <div className="pr-20 pt-10">
                        {<IntlMessages id="wallet.24limit" />}：{this.state.DailyLimit} BTC,  {<IntlMessages id="wallet.inUse" />}：{this.state.UsedLimit} BTC
                    </div>
                </div>
                <div className="row">
