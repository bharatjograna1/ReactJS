...
class PairList extends React.Component {
    ...
    addToFavourite = (event,value) => {
        ...
        if (this.state.favouritesPairList) {
            ...
            if (isAvailable !== -1) {
                const PairData = this.state.favouritesPairList[isAvailable];
    ...
    //}
        ...
        return (
            <div className="d-sm-full p-0">               
                ...
                <Row>
                    <Col md={12}>
                        <Nav tabs className="dropdownboxmenu">   
                        <NavItem>
                ...
                {this.state.showLoader &&
                 <JbsSectionLoader />
                    ...
                    <div className={this.props.darkMode ? 'AdvacePairListtable-darkmode':'AdvacePairListtable'}>
                        ...
                        <div>
                            ...
                            <Scrollbars className="jbs-scroll" autoHeight autoHeightMin={250} autoHeightMax={360} autoHide>
