...
class MarketOrder extends React.Component {
  state = {
    ...
    priceBuy: this.props.currentPrice.BuyPrice  ? parseFloat(this.props.currentPrice.BuyPrice).toFixed(8) : parseFloat(0).toFixed(8),
    amountBuy: "",
    totalBuy: "",

    priceSell:this.props.currentPrice.SellPrice  ? parseFloat(this.props.currentPrice.SellPrice ).toFixed(8) : parseFloat(0).toFixed(8),
    amountSell: "",
    totalSell: "",
    showLoader: false,
  ...
  componentWillReceiveProps(nextprops) {
    ...
    if(nextprops.currentPrice){
      ...
      if(nextprops.currentPrice.BuyPrice !== this.props.currentPrice.BuyPrice){
        this.setState({          
          priceBuy : parseFloat(nextprops.currentPrice.BuyPrice).toFixed(8),
          amountBuy:"",
          totalBuy:""
        })
      } else if(this.props.handleChange !== this.props.handleChange){
        this.setState({          
          priceBuy : parseFloat(nextprops.currentPrice.BuyPrice).toFixed(8),
          amountBuy:"",
          totalBuy:""           
      ...
      if(nextprops.currentPrice.SellPrice !== this.props.currentPrice.SellPrice){
        this.setState({          
          priceSell : parseFloat(nextprops.currentPrice.SellPrice).toFixed(8),
          amountSell:"",
          totalSell:"" 
        })
      } else if(this.props.handleChange !== this.props.handleChange){
  ...
  render() {
    ...
    return (
      <Row>
        ...
        <Col sm={6} xs={6} className="comminborderright buysellbox">
            ...
            <div className="mb-10 mt-10">
              <Form>
                <FormGroup className="mb-10">
                  <Row>
                    <Col sm={4}>
                      <Label className="col-form-label" for="Price">{<IntlMessages id="trading.placeorder.market.label.price" />} </Label>
                    </Col>
                    <Col sm={8}>
                      <Input
                        type="text"
                ...
                <FormGroup className="mt-20 mb-0">
                    <Button
                    type="submit"
                      name={
