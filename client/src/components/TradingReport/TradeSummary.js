...
class MembershipLevelProfileWdgt extends Component {
  ...
  validateNumericValue = event => {
    ...
    if (regexNumeric.test(event.target.value) || event.target.value === '') {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (nextProps.tradeSummaryList && nextProps.error.length == 0) {
      this.setState({
        ...
        <div className="charts-widgets-wrapper">
          ...
          <div className="m-20 page-title d-flex justify-content-between align-items-center">
            <div className="page-title-wrap">
              <h2>{<IntlMessages id="tradeSummary.title.report" />}</h2>
            </div>
                    ...
                    <div className="top-filter clearfix">
                      <Form name="frm_search" className="row mb-10">
                        <div className="col-md-3">
                          <Label for="startDate1">{<IntlMessages id="sidebar.tradeSummary.filterLabel.startDate" />}</Label>
                        ...
                        <div className="col-md-3">
                          <Label for="endDate1">{<IntlMessages id="sidebar.tradeSummary.filterLabel.endDate" />}</Label>
                          <Input type="date" name="end_date" value={this.state.end_date} id="endDate1" placeholder="dd/mm/yyyy" onChange={this.handleChange} />
                        </div>

                        <div className="col-md-3">
                          <Label for="Select-2">{<IntlMessages id="tradeSummary.filterLabel.trnNo" />}</Label>
                        ...
                        <div className="col-md-3">
                          <Label for="Select-1">{<IntlMessages id="sidebar.tradeSummary.filterLabel.currencyPair" />}</Label>
                          <div className="app-selectbox-sm">
                        ...
                        <div className="col-md-3">
                          <Label for="Select-2">{<IntlMessages id="tradeSummary.orderType.label" />}</Label>
                          <div className="app-selectbox-sm">
                      ...
                      <MUIDataTable
                        ...
                        data={data.map(item => {
                          ...
                          return [
                            ...
                            item.Qty ? parseFloat(item.Qty).toFixed(8) : 0,
