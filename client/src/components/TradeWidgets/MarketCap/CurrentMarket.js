        ...
        <div className="p-0 m-0">
          {this.state.currentMarket ? (            
                  <div className="row text-center m-0 p-0 ">
                    ...
                    <Col lg={2} md={3} sm={4} xs={4} className="currentmarketbox">     
                        <h3>{this.props.firstCurrency+"/"+this.props.secondCurrency}
                        <p>{this.state.currentMarket.name}</p></h3>
                    </Col>
                    ...
                    <Col lg={2} md={3} sm={4} xs={4} className="currentmarketbox">
                      ...
                      <p className={this.state.Change24 < this.state.currentMarket.Change24 ? 'text-success':'text-danger'}>{this.state.currentMarket.Change24 !==undefined ?                         
                        parseFloat(this.state.currentMarket.Change24).toFixed(8):0}</p></h3>   
                    </Col>
                    ...
                    <Col lg={2} md={3} sm={4} xs={4} className="currentmarketbox">
                      ...
                      <p>{this.state.currentMarket.High24 !== undefined ? parseFloat(this.state.currentMarket.High24).toFixed(8):0}</p></h3>
                    </Col>
                    ...
                    <Col lg={2} md={3} sm={4} xs={4} className="currentmarketbox">
                      ...
                      <p>{this.state.currentMarket.Low24 !== undefined ? parseFloat(this.state.currentMarket.Low24).toFixed(8):0}</p></h3>
                    </Col>
                    ...
                    <Col lg={2} md={3} sm={4} xs={4} className="currentmarketbox">
                      ...
                      <p>{this.state.currentMarket.Volume24 !== undefined ? parseFloat(this.state.currentMarket.Volume24).toFixed(8):0}</p></h3>   
                    </Col>
                  </div>             
          ) : (
            <div>
...
const mapStateToProps = state => ({
  ...
  loading: state.currentMarketCap.loading,
});
