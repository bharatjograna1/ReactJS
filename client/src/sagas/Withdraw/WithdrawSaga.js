...
function* confirmaWithdrawRequest(payload) {
    const response = {
        "Response": {
            "TrnNo": 3820,
            "TransactionAddress": "3k87ujzngr7cyfqlnxyd5tye44rzouia9d",
            "Currency": "BTC",
            "Amount": 1.55,
            "Fee": 0,
            "TrnDate": "2019-01-12T10:38:36.5589767",
            "Status": 1,
            "IsVerified": 1,
            "StatusMsg": "Success"
        },
        "ReturnCode": 0,
        "ReturnMsg": "Transaction Confirm Success.",
        "ErrorCode": 11016
    };
    yield put(confirmaWithdrawSuccess(response));
    // var headers = { 'Authorization': AppConfig.authorizationToken }
    // const responseFromSocket = yield call(swaggerPostAPI, 'api/Manage/TwoFAVerifyCode', payload.request, headers);
    // try {
    //     if (lgnErrCode.includes(responseFromSocket.statusCode)) {
