...
function* getBuyerOrderData({ payload }) {
    ...
    try {
        ...
        const response = yield call(swaggerGetAPI,'api/Transaction/GetBuyerBook/'+payload.Pair,{});
...
function* getSellerOrderData({ payload }) {
    ...
    try {
        ...
        const response = yield call(swaggerGetAPI,'api/Transaction/GetSellerBook/'+payload.Pair,{});
...
function* getMarketTradeHistoryData({ payload }) {
    ...
    try {
        ...
        const response = yield call(swaggerGetAPI,'api/Transaction/GetOrderhistory?Pair='+payload.Pair,{});
...
function* getPairListData({ }) {
    
    try {

        const response = yield call(swaggerGetAPI,'api/Transaction/GetTradePairAsset',{});
...
function* getFavouritePairRequest({payload}) {    
    ...
    const response = yield call(swaggerGetAPI,'api/Transaction/GetFavouritePair',{},headers);
...
function* addToFavouritePairRequest({payload}) {    
    ...
    var headers =  {'Authorization': AppConfig.authorizationToken}
    const response = yield call(swaggerPostAPI,'api/Transaction/AddToFavouritePair/'+PairId,{},headers);   
...
function* removeFromFavouritePairRequest({payload}) {    
    ...
    var headers =  {'Authorization': AppConfig.authorizationToken}
    const response = yield call(swaggerPostAPI,'api/Transaction/RemoveFromFavouritePair/'+ pair,{},headers);   
