...
class withdrawConfirmation extends Component {
    ...
    render() {
        ...
        const Response = this.props.confirmationResponse.hasOwnProperty("Response") ? this.props.confirmationResponse.Response : {};
                    ...
                    {this.props.confirmationResponse.loading ? < JbsSectionLoader /> :
                        <div className="col-sm-6 offset-3">
                            ...
                            <div className="col-sm-12 p-0 d-flex">
                                ...
                                <h4 className="p-10 m-0">{Response.hasOwnProperty("Amount") ? Response.Amount : ""}</h4>
                            </div>
                            <Divider />
                            <div className="col-sm-12 p-0 d-flex">
                                <h4 className="w-40 p-10 m-0">
                                ...
                                <h4 className="p-10 m-0">{Response.hasOwnProperty("Fee") ? Response.Fee : ""}</h4>
                            </div>
                            <Divider />
                            <div className="col-sm-12 p-0 d-flex">
                                <h4 className="w-40 p-10 m-0">
                                ...
                                <h4 className="p-10 m-0">{Response.hasOwnProperty("TrnDate") ? changeDateFormat(Response.TrnDate, 'YYYY-MM-DD HH:mm:ss') : ""}</h4>
                            </div>
                            <Divider />
                            <div className="col-sm-12 p-0 d-flex">
                                <h4 className="w-40 p-10 m-0">
